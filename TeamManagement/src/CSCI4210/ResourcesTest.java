...
public class ResourcesTest {
	...
	@Test 
	public void decreaseNumericalValTest() {
		
		double val1 = 500.0;
		double val2 = 1000.0;
		
		resource1.decreaseNumericalVal(val1);	
				
		assertFalse(resource1.getNumericalVal() == 1000.0);
		
		assertTrue(resource1.getNumericalVal() == 500.0);
		
		resource3.decreaseNumericalVal(val2);
		
		assertNotEquals(3000.0,resource3.getNumericalVal(),0.001);
		
		assertEquals(1000.0,resource3.getNumericalVal(),0.001);				
