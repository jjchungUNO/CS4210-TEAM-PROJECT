...
public class TeamMembersTest {
	...
	public void getFullNameTest() {
		assertEquals("jacob jorda",member1.getFullName());
		
		assertNotEquals("JACob jorda",member1.getFullName());			
		
		TeamMembers member9  = null;
		member9 = member6;
		assertNotNull(member9.getFullName());
		
		assertEquals("john john",member9.getFullName());
	}	
}
